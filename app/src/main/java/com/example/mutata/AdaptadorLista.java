...
public class AdaptadorLista extends RecyclerView.Adapter<AdaptadorLista.viewHolder> {
    ...
    public class viewHolder extends RecyclerView.ViewHolder {
        ...
        public viewHolder(@NonNull View itemView) {
            ...
            descripcionCultura= itemView.findViewById(R.id.descripcionCultura);
        ...
        public void actualizarDatosDeItem(final Actividad actividad) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(itemView.getContext(), activity_cultura.class);
                    intent.putExtra("cultural", actividad);
